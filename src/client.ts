...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['FASTVM_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['FASTVM_LOG'] or 'warn' if it isn't set.
   */
...
export class Fastvm {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Fastvm.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('FASTVM_LOG'), "process.env['FASTVM_LOG']", this) ??
      defaultLogLevel;
  ...
  static FastvmError = Errors.FastvmError;
